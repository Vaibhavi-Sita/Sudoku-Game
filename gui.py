...
class GUI:
    ...
    def _draw_ui(self):
        ...
        self.menu_texts = {}
        self.menu = {}
        for size, word, x, y in [(80, "SUDOKU", WIDTH//2, 80),
                                 (15, "VSITA", WIDTH - 30, HEIGHT - 10),
...
class Tile:
    ...
    def __init__(self, value, x, y, sudoku_i, sudoku_j, size):
        ...
        self._font_color = COLORS["blue"] if self.is_fillable else COLORS["pink"]
        self._value = value
